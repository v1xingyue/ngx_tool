...
$(function(){
    ...
    var end = uri.length - 5;
    var class_and_page = uri.substring(3,end);
    if( -1 == class_and_page.indexOf("_")) {
           class_and_page = class_and_page + "_0";
    }
    var new_uri = "http://10.13.0.41/class_content/" +  class_and_page + ".html";
